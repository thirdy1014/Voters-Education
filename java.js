...
function randomWords(diff){
  ...
  var concWords = ["Voter", "education", "is", "crucial", "junction", "in", "the", "Philippines", "to", "ensure", "that", "citizens", "are", "able", "to", "make", "informed", "decisions", "when", "they", "cast", "their", "ballots", "and", "to", "be", "critical", "of", "the", "common", "misconceptions", "regarding", "the", "Philippine", "elections.", "However,", "there", "are", "many", "misconceptions", "about", "what", "voter", "education", "actually", "entails.", "Some", "people", "believe", "that", "it", "is", "simply", "a", "matter", "of", "providing", "information", "about", "the", "mechanics", "of", "voting", "such", "as", "how", "to", "mark", "a", "ballot", "or", "where", "to", "go", "to", "cast", "it.", "In", "reality,", "voter", "education", "goes", "much", "deeper", "than", "that,", "encompassing", "topics", "such", "as", "political", "issues,", "candidates'", "platforms,", "and", "the", "role", "of", "government", "in", "society.", "In", "addition", "to", "this,", "voter", "education", "also", "serves", "to", "encourage", "civic", "engagement", "and", "participation", "in", "the", "democratic", "process.","By", "fostering", "an", "informed", "and", "engaged", "electorate,", "voter", "education", "can", "help", "to", "ensure", "that", "the", "government", "reflects", "the", "will", "of", "the", "people", "and", "is", "accountable", "to", "them.", "Ultimately,", "it", "is", "through", "education", "and", "participation", "that", "citizens", "can", "play", "an", "active", "role", "in", "shaping", "the", "future", "of", "their", "country."];
